...
exports.level = ->
  ...
  @clue "Call warrior.feel(direction).isEnemy() in each direction to make sure there isn't an enemy beside you (attack if there is). Call warrior.rest() if you're low and health when there's no enemies around."
